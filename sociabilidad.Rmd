...
\]  
donde \(\Phi(\cdot)\) denota la función de distribución acumulada de una **Normal estándar**. Esta función se utilizada como **función de enlace** para garantizar que las **probabilidades** \(\theta_{i,j}\) permanezcan dentro del intervalo \((0, 1)\).    
