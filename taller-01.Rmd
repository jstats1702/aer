...
9. Sintetizar y replicar la sección 2.4.2 (*Special Types of Graphs*, p. 24) de *Statistical Analysis Of Network Data With R* (Kolaczyk y Csárdi, 2020).

10. Sintetizar y explicar el problema de los puentes de Königsberg (https://www.youtube.com/watch?v=nZwSo4vfw6c&ab_channel=TED-Ed).

11. Sintetizar y explicar la paradoja de la amistad (https://www.youtube.com/watch?v=E5f68Xbtd6s&ab_channel=Derivando).