...
Los detalles del modelo se pueden consultar en https://jchiquet.github.io/MAP566/docs/mixture-models/map566-lecture-graph-clustering-part2.html
...
plot(fblog, 
     ...
     vertex.label = NA, 
     vertex.size = 4,
     vertex.color = cols[party.nums], 
     vertex.frame.color = cols[party.nums], 
...
set.seed(42)
fblog.sbm <- blockmodels::BM_bernoulli(membership_type = "SBM_sym", 
                                       adj = A, 
                                       verbosity = 0, 
                                       plotting = "")
# estimación
