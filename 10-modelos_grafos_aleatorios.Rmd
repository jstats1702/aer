...
knitr::include_graphics("10_modelos_box.png")
```
...
knitr::include_graphics("10_modelos_cv.jpg")
```
...
```{r, eval = TRUE, echo=FALSE, out.width="85%", fig.pos = 'H', fig.align = 'center'}
knitr::include_graphics("10_modelos_matriz_confusion.jpeg")
```
...
```{r, eval = TRUE, echo=FALSE, out.width="85%", fig.pos = 'H', fig.align = 'center'}
knitr::include_graphics("10_modelos_curva_roc.png")
```
